...
import logoDetalhe from '@/assets/img/Detalhe-logo.png';
    ...
    <footer className="bg-muted text-muted-foreground section-padding">
      <div className="container mx-auto">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-center">
                ...
                <a href="https://wa.me/5571981018563" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
                  +55 71 98101-8563
                </a>
              </li>
              <li className="flex items-center">
                <Instagram className="w-5 h-5 mr-3 text-primary flex-shrink-0" />
                <a href="https://instagram.com/detalhe_cortinas" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
                  @detalhe_cortinas
                </a>
              </li>
            </ul>
        ...
        <div className="mt-12 pt-8 border-t border-border/40 text-center text-sm">
          <p>&copy; {currentYear} Detalhe Cortinas & Persianas. Todos os direitos reservados.</p>
          <p className="mt-1">
            desenvolvido por{' '}
            <a
              href="https://luanbelondev.com"
              target="_blank"
