...
import galleryImg002 from '@/assets/img/002.jpeg';
import galleryImg003 from '@/assets/img/003.jpeg';
import galleryImg004 from '@/assets/img/6.jpeg';
...
export const defaultSiteContent = {
  ...
  gallery: {
    ...
    background: { type: 'class', value: 'bg-muted' },
    items: [
      { id: 'gal-1', src: galleryImg002, alt: 'Projeto de cortina e persiana sob medida 002' },
      { id: 'gal-2', src: galleryImg003, alt: 'Projeto de cortina e persiana sob medida 003' },
      { id: 'gal-3', src: galleryImg004, alt: 'Projeto de cortina e persiana sob medida 004' },
    ],
  },
  contact: {
